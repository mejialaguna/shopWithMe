      ...
      {options?.map((option, idx) => (
        ...
        >
          <input
            ...
            className={`w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 focus:ring-blue-500 cursor-pointer dark:focus:ring-blue-600 dark:ring-offset-gray-700 dark:focus:ring-offset-gray-700 focus:ring-2 dark:bg-gray-600 dark:border-gray-500 ${errors[`${name}`] ? 'dark:focus:ring-red-600' : 'dark:focus:ring-blue-600'}`}
            {...registerProps}
          />
          <label
